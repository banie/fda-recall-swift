...
- To keep it simple, if user does pull to refresh, then I clear persistence and start from page 0 again. I didn't want to overcomplicate the list state management and use complicated algorithm to detect gaps between fresh and saved data
